...
// import { MetricsProviderInternal, DataFetcher, ExploreV2Query, EXPLORE_V2_DIMENSIONS, ExploreV2Filter } from '@kong-ui/analytics-metric-provider'
...
//   (queryTime: QueryTime, query: ExploreV2Query) =>
//   portalApiV2.value.post(`/api/v2/stats/explore?startMs=${queryTime.startMs()}&endMs=${queryTime.endMs()}`, query)
